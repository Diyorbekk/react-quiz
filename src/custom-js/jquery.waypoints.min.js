(function (e) {
    ...
    e.scrollActive = function (t) {
        ...
        var u = function (t) {
            var n = e(t.target).closest("[data-animate-effect]").attr("data-animate-effect") || e(t.target).closest("[data-scroll-goto]").attr("data-scroll-goto");
            o(parseInt(n))
        };
        var a = function (t) {
            var r = t.which;
        ...
        var f = function (t) {
            ...
            i = t;
            e("[data-animate-effect=" + t + "]").addClass(n.activeClass)
        };
        var l = function () {
